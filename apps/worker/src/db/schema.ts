// AUTO-GENERATED from schema.sql — do not edit by hand. Regenerate: node src/db/generate-schema.mjs
export const SCHEMA_SQL = `-- HYDRA schema — see docs/DESIGN_data-and-api.md (track file §5)
