          ...
          events.map((e, i) => {
            ...
            return (
              <div key={i} className="px-4 py-2.5 flex items-start gap-3 text-sm">
                <span className="mono text-[11px] mt-0.5" style={{ color: "var(--muted)" }}>
                  {e.ts.slice(11, 19)}
                </span>
                ...
                <span className="flex-1 mono text-xs truncate" style={{ color: "var(--muted)" }}>
